...
bool StackOk(const Stack_t *this_) // TODO this function & dublicate internal data
{
    return true;
}

bool StackDump(const Stack_t *this_) // TODO this function
{
    FILE *fd = fopen(this_->file_dump, "wb+");
    if (!fd)
        return false;
